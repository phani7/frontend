...
const Footer = () => {
  return (
    <footer>
      ...
      <div class="image">
      <a
        href="https://www.instagram.com/phanik7/"
        target="_blank"
      >
        <img
     ...
     <div class ="image"><a href="https://api.whatsapp.com/send/?phone=919553892262&text&app_absent=0" target="_blank">
        <img
      ...
      <div class="image"><a
        href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=DmwnWrRnZNDjtnbmkdFrKCqWsKZJKZzGDlwxqNHHSpkGttBNJQxpbshrfXFpWJtkwDFntMlwdBpB"
        target="_blank"
      >
        <img
      ...
      <div class="image">   <a 
        href="https://www.linkedin.com/in/phanideepk/" target="_blank">
        <img
