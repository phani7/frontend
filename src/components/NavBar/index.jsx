    ...
    <nav className="navbar">
      <div className="nav-wrapper">
        <div className="logo">
          <Link to="/">
            <img
              src="https://us.123rf.com/450wm/wikagraphic/wikagraphic2010/wikagraphic201033901/158095260-letter-kp-logotype-design-for-company-name-colored-blue-swoosh-vector-logo-for-business-and-company-.jpg?ver=6"
              alt="brand"
            />
          </Link>
        </div>
